...
export function getServerConfig(flags: ServerFlags): ServerConfig {
  ...
  const designDensity = resolve<"auto" | "mdpi" | "xhdpi" | "xxhdpi">(
    flags.designDensity as "auto" | "mdpi" | "xhdpi" | "xxhdpi" | undefined,
    envStr("FRAMELINK_DESIGN_DENSITY") as "auto" | "mdpi" | "xhdpi" | "xxhdpi" | undefined,
    "auto",
  );
